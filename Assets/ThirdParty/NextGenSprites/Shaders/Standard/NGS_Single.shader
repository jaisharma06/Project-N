        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
				...
				//Dissolve
					...
					half DissolveCondition_if_leA = step(_DissolveBorderWidth, DissolvePow);
					half DissolveCondition_if_leB = step(DissolvePow, _DissolveBorderWidth);
					emissive += (lerp((DissolveCondition_if_leA * 0.0) + (DissolveCondition_if_leB * 1.0), 0.0, DissolveCondition_if_leA * DissolveCondition_if_leB) * _DissolveGlowStrength * _DissolveGlowColor.rgb);
				#endif
